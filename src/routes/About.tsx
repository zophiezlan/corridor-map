    ...
    <div className="max-w-2xl prose-stone">
      ...
      <section className="mt-6 space-y-3 text-stone-700 dark:text-stone-300 leading-relaxed">
        ...
        <p>
          ...
          mechanisms the Australian tax system provides. For computable
          corridors (MLS, packaging, super cap) it calculates your position,
          utilisation, and the marginal value of your next actions. For
          judgement-heavy corridors (first-home schemes, deductions) it provides
        ...
        <p>
          ...
          <strong>{FINANCIAL_YEAR_LABEL}</strong>. Sources: ATO (income tax
          brackets, MLS thresholds, super caps, HECS schedule) and
          PrivateHealth.gov.au (rebate rates, age-based discount). Every
          calculated number has a tooltip showing the formula used.
        </p>
        <p>
          The tool makes simplifying assumptions suited to a typical PBI worker:
          single filer, no investment property, no family trust distributions,
          no spouse for MLS purposes. If any of those don't match your
