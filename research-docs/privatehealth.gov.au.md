...
There are [different types of cover](https://www.privatehealth.gov.au/health_insurance/howitworks/index.htm "How it works") that offer different benefits. Check with your health insurer to be sure of exactly what you are covered for.
...
Four new tiers of hospital cover began rolling out from 1 April 2019 and became mandatory from 1 April 2020. All hospital insurance policies are classified as Gold, Silver, Bronze or Basic. For more information about the new tiers, see [Product tiers](https://www.privatehealth.gov.au/health_insurance/howitworks/producttiers.htm "Product tiers") & [Clinical categories](https://www.privatehealth.gov.au/health_insurance/howitworks/clinical_categories.htm "Clinical categories").

As with any other insurance policy, you can [manage your cover](https://www.privatehealth.gov.au/health_insurance/howitworks/managing_your_policy.htm "Managing your policy") by choosing comprehensive cover with higher premiums, or pay lower premiums for reduced cover. You can also reduce your premiums by opting to pay some of the costs through an excess or co-payment.

For more information about hospital cover, see [Private Health Insurance Basics](https://www.privatehealth.gov.au/health_insurance/howitworks/index.htm "Private Health Insurance Basics").
...
For more advice about exclusions and restrictions, see the [Ombudsman's factsheet](https://www.ombudsman.gov.au/publications-and-news-pages/publication-pages/brochures-and-factsheets/factsheets/private-health-insurance/policy-exclusions-and-restrictions "Factsheet - Policy Exclusions and Restrictions"). For information about other expenses you may have to pay, see [Out of pocket expenses (gap cover)](https://www.privatehealth.gov.au/health_insurance/howitworks/out_of_pocket.htm "Out of pocket expenses (gap cover)").
...
You should check the [Private Health Information Statement](https://www.privatehealth.gov.au/health_insurance/howitworks/phis_guide.htm "Private Health Information Statements") about any policy you are interested in, and seek information from your insurer for details of these limitations.
...
The options for ambulance cover vary depending on what state or territory you live in. For further information please see the [Ambulance](https://www.privatehealth.gov.au/health_insurance/what_is_covered/ambulance.htm "Ambulance") section of the website.
...
Most Australians with private health insurance currently receive a rebate from the Australian Government to help cover the cost of their premiums. The private health insurance rebate is income tested. The table below details the different rebate amounts.

The rebate applies to hospital, general treatment and ambulance policies provided by Australian registered health insurers. It does not apply to [overseas visitors health cover](https://www.privatehealth.gov.au/health_insurance/overseas/overseas_visitors_health_cover.htm "Overseas Visitors Health Cover") or other types of insurance.

The income thresholds and rebates that apply for **1 July 2025** to **31 March 2026** are:
...
The income thresholds and rebates that apply for **1 April 2026** to **30 June 2026** are:
...
The income thresholds and rebates that apply from **1 July 2026** to **31 March 2027** are:
...
_Single parents and couples (including de facto couples) are subject to family tiers. For families with children, the income thresholds are increased by $1,500 for each child after the first._

### How can I work out my rebate entitlement?

You can use the table above or the [Private Health Insurance Rebate Calculator](https://www.ato.gov.au/calculators-and-tools/tax-offsets-private-health-insurance-rebate-calculator "Link - ATO - Private Health Insurance Rebate Calculator") on the ATO website, or call the Australian Taxation Office (ATO) on **132 861**.
...
- as a tax offset when lodging your annual tax return. For more information about claiming your rebate as a tax offset, visit the [Australian Taxation Office](https://www.ato.gov.au/individuals-and-families/medicare-and-private-health-insurance/private-health-insurance-rebate "Link - ATO - Rebate") or call 132 861.
...
For further information about claiming the rebate please visit the ATO's website: [Private Health Insurance Rebate](https://www.ato.gov.au/individuals-and-families/medicare-and-private-health-insurance/private-health-insurance-rebate "Link - ATO - Rebate").
...
[Lifetime Health Cover](https://www.privatehealth.gov.au/health_insurance/surcharges_incentives/lifetime_health_cover.htm "Lifetime Health Cover") (LHC) is a financial loading applied on top of your hospital premium at a rate of 2% for every year you are aged over 30 when you take out hospital cover, up to a maximum of 70%. The LHC loading is removed once you have held hospital cover and paid the loading for 10 continuous years.
...
The age-based discount does not apply to people aged 18-29 years who are covered as a dependent on a family or single parent policy. A person can either have their own policy and be eligible for an age-based discount, or be covered as a dependent, but not both.

If a policy offers age-based discounts they are available to both new and existing policy holders.

### What if I change policies or insurers?
...
Insurers can choose whether their age-based discounted products honour existing age-based discounts when a consumer transfers between discounted products and insurers.

### What are the discount rates per age?

| Age when insured | Discount |
| ---------------- | -------- |
| 18–25            | 10%      |
| 26               | 8%       |
| 27               | 6%       |
...
The Medicare Levy Surcharge (MLS) is a levy paid by Australian tax payers who do not have private hospital cover and who earn above a certain income. The surcharge aims to encourage individuals to take out [private hospital cover](https://www.privatehealth.gov.au/health_insurance/what_is_covered/privatehealth.htm "What is covered by private health insurance?"), and where possible, to use the private system to reduce the demand on the public [Medicare](https://www.privatehealth.gov.au/health_insurance/what_is_covered/medicare.htm "What is covered by Medicare?") system.
...
For more information about who is considered a dependant for MLS purposes, you can refer to the [ATO's Medicare Levy Surcharge page](https://www.ato.gov.au/individuals-and-families/medicare-and-private-health-insurance/medicare-levy-surcharge "Link - ATO Medicare Levy Surcharge").

The surcharge is calculated at the rate of 1% to 1.5% of your income for Medicare Levy Surcharge purposes. It is in addition to the Medicare Levy of 2%, which is paid by most Australian taxpayers. To work out your annual income for MLS and Rebate purposes, you can refer to the Australian Taxation Office's [Private Health Insurance Rebate Calculator](https://www.ato.gov.au/calculators-and-tools/tax-offsets-private-health-insurance-rebate-calculator "Link - ATO - Private Health Insurance Rebate Calculator") or contact the ATO directly.

The income thresholds and surcharges that apply for **1 July 2025** to **30 June 2026** are:

| Singles                     | ≤$101,000 | $101,001-118,000 | $118,001-158,000 | ≥$158,001 |
| --------------------------- | --------- | ---------------- | ---------------- | --------- |
| **Medicare Levy Surcharge** | 0.0%      | 1.0%             | 1.25%            | 1.5%      |

The income thresholds and surcharges that apply for **1 July 2026** to **30 June 2027** are:
